...
async function main() {
    ...
    const services = [
        // --- Haircut & Styling (MEN) ---
        { name: 'Haircut', category: 'Hair & Styling', subCategory: 'Cuts', duration: 30, priceType: 'Fixed', defaultPrice: 150, gender: 'Male', description: 'Professional haircut' },
        { name: 'Beard', category: 'Grooming Essentials', subCategory: 'Beard', duration: 20, priceType: 'Fixed', defaultPrice: 100, gender: 'Male', description: 'Beard grooming and shaping' },
        { name: 'Hairwash', category: 'Hair & Styling', subCategory: 'Wash', duration: 15, priceType: 'Fixed', defaultPrice: 50, gender: 'Male', description: 'Deep cleansing hair wash' },
        { name: 'Deep Conditioning', category: 'Hair & Styling', subCategory: 'Treatment', duration: 30, priceType: 'Fixed', defaultPrice: 150, gender: 'Male', description: 'Intense hair conditioning' },
        { name: 'Baby Haircut', category: 'Hair & Styling', subCategory: 'Cuts', duration: 30, priceType: 'Fixed', defaultPrice: 100, gender: 'Male', description: 'Gentle haircut for kids' },

        // --- Hair Spa (MEN) ---
        { name: 'Normal Hair Spa', category: 'Hair Treatments', subCategory: 'Spa', duration: 45, priceType: 'Fixed', defaultPrice: 500, gender: 'Male', description: 'Relaxing hair spa' },
        { name: 'Loreal Hair Spa', category: 'Hair Treatments', subCategory: 'Spa', duration: 60, priceType: 'Fixed', defaultPrice: 800, gender: 'Male', description: 'Premium Loreal hair spa' },
        { name: 'Anti Dandruff', category: 'Hair Treatments', subCategory: 'Treatment', duration: 45, priceType: 'Fixed', defaultPrice: 1500, gender: 'Male', description: 'Effective dandruff treatment' },
        { name: 'Hairfall Treatment', category: 'Hair Treatments', subCategory: 'Treatment', duration: 45, priceType: 'Fixed', defaultPrice: 1500, gender: 'Male', description: 'Specialized hairfall control' },
        { name: 'Keratine Spa', category: 'Hair Treatments', subCategory: 'Spa', duration: 60, priceType: 'Fixed', defaultPrice: 1000, gender: 'Male', description: 'Smoothing keratin spa' },

        // --- Massage (MEN) ---
        { name: 'Head Massage', category: 'Massage & Wellness', subCategory: 'Massage', duration: 20, priceType: 'Fixed', defaultPrice: 250, gender: 'Male', description: 'Tension-relieving head massage' },
        { name: 'Full Body Massage', category: 'Massage & Wellness', subCategory: 'Massage', duration: 60, priceType: 'Fixed', defaultPrice: 1250, gender: 'Male', description: 'Total body relaxation' },
        { name: 'Body Massage with Steam', category: 'Massage & Wellness', subCategory: 'Massage', duration: 75, priceType: 'Fixed', defaultPrice: 1500, gender: 'Male', description: 'Massage followed by steam bath' },
        { name: 'Body Spa', category: 'Massage & Wellness', subCategory: 'Spa', duration: 90, priceType: 'Fixed', defaultPrice: 2500, gender: 'Male', description: 'Luxurious body spa treatment' },
        { name: 'Body Polishing', category: 'Massage & Wellness', subCategory: 'Advanced', duration: 90, priceType: 'Fixed', defaultPrice: 3500, gender: 'Male', description: 'Skin smoothing body polish' },
        { name: 'Back Massage', category: 'Massage & Wellness', subCategory: 'Massage', duration: 30, priceType: 'Fixed', defaultPrice: 500, gender: 'Male', description: 'Focused back relaxation' },

        // --- Cleanup (MEN) ---
        { name: 'Normal Cleanup', category: 'Facial & Skin Care', subCategory: 'Clean-up', duration: 30, priceType: 'Starting at', defaultPrice: 500, gender: 'Male', description: 'Basic skin cleanup' },

        // --- D-Tan (MEN) ---
        { name: 'Face D-Tan', category: 'Facial & Skin Care', subCategory: 'D-Tan', duration: 20, priceType: 'Fixed', defaultPrice: 300, gender: 'Male', description: 'Face tan removal' },
        { name: 'Raaga D-Tan', category: 'Facial & Skin Care', subCategory: 'D-Tan', duration: 20, priceType: 'Fixed', defaultPrice: 400, gender: 'Male', description: 'Tan removal with Raaga products' },
        { name: 'O3 D-Tan', category: 'Facial & Skin Care', subCategory: 'D-Tan', duration: 20, priceType: 'Fixed', defaultPrice: 500, gender: 'Male', description: 'Premium O3+ tan removal' },

        // --- Colouring (MEN) ---
        { name: 'Full Hair Colour Loreal', category: 'Hair Colouring', subCategory: 'Global', duration: 60, priceType: 'Fixed', defaultPrice: 600, gender: 'Male', description: 'Loreal full hair color' },
        { name: 'Loreal Beard Colour', category: 'Hair Colouring', subCategory: 'Beard', duration: 30, priceType: 'Fixed', defaultPrice: 250, gender: 'Male', description: 'Loreal beard coloring' },
        { name: 'Highlights per strip', category: 'Hair Colouring', subCategory: 'Highlights', duration: 20, priceType: 'Fixed', defaultPrice: 150, gender: 'Male', description: 'Single strip hair highlights' },
        { name: 'Global Fashion Colour', category: 'Hair Colouring', subCategory: 'Global', duration: 60, priceType: 'Fixed', defaultPrice: 1500, gender: 'Male', description: 'Trendy fashion hair color' },
        ...
        { name: 'Women: Bridal Makeup', category: 'Makeup & Bridal', subCategory: 'Makeup', duration: 180, priceType: 'Starting at', defaultPrice: 15000, gender: 'Female', description: 'Complete bridal transformation' },
        ...
        { name: 'Smoothing Mega Combo', category: 'Premium Packages', subCategory: 'Hair & Skin', duration: 240, priceType: 'Fixed', defaultPrice: 4999, gender: 'Female', description: 'Hair Smoothing (Any Length), Haircut, Hair Wash, Normal Hair Spa' },
