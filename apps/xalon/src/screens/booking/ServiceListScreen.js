...
const styles = StyleSheet.create({
    ...
    modalBody: { padding: 24, paddingTop: 20 },
    modalTitle: { fontSize: 22, fontWeight: '900', color: colors.text, letterSpacing: -0.5, marginBottom: 10 },
    modalMeta: { flexDirection: 'row', alignItems: 'center', gap: 10, marginBottom: 4 },
    modalPriceContainer: { flexDirection: 'row', alignItems: 'center', gap: 8 },
    modalPrice: { fontSize: 24, fontWeight: '900', color: colors.primary },
    modalPriceOriginal: { fontSize: 16, color: colors.gray, textDecorationLine: 'line-through', fontWeight: '500' },
    modalDuration: { fontSize: 14, color: colors.gray, fontWeight: '600' },
    divider: { height: 1, backgroundColor: colors.grayBorder, marginVertical: 16 },
    modalSectionTitle: { fontSize: 15, fontWeight: '800', color: colors.text, marginBottom: 12, textTransform: 'uppercase', letterSpacing: 0.5 },
    modalDesc: { fontSize: 15, color: colors.gray, lineHeight: 24, fontWeight: '400' },

    // Steps
    stepItem: { flexDirection: 'row', gap: 14, marginBottom: 16 },
    stepNumber: { width: 28, height: 28, borderRadius: 14, backgroundColor: colors.primary + '15', justifyContent: 'center', alignItems: 'center', flexShrink: 0, marginTop: 2 },
    stepNumberText: { fontSize: 13, fontWeight: '900', color: colors.primary },
    stepContent: { flex: 1 },
    stepTitle: { fontSize: 14, fontWeight: '800', color: colors.text, marginBottom: 3 },
    stepDesc: { fontSize: 13, color: colors.gray, lineHeight: 20 },

    // FAQs
    faqItem: { marginBottom: 14, backgroundColor: colors.background, borderRadius: 14, padding: 14 },
    faqQ: { fontSize: 14, fontWeight: '800', color: colors.text, marginBottom: 6 },
    faqA: { fontSize: 13, color: colors.gray, lineHeight: 20 },

    // Modal footer
    modalFooter: { padding: 20, paddingBottom: 32, borderTopWidth: 1, borderTopColor: colors.grayBorder },
    modalAddBtn: { backgroundColor: colors.primary, paddingVertical: 18, borderRadius: 20, alignItems: 'center', elevation: 6, shadowColor: colors.primary, shadowOpacity: 0.4, shadowRadius: 10 },
    modalAddBtnText: { color: colors.white, fontWeight: '900', fontSize: 16, letterSpacing: 1 },
});
